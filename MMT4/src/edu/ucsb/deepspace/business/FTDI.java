...
//			e.printStackTrace();
//		}
//		System.out.println(fTDevices.size());
//		for (FTDevice fTDevice : fTDevices) {
//			if (fTDevice.getDevSerialNumber().equals("A3000wLU")) {
//				ft245handle = fTDevice;
//			}
//			else if (fTDevice.getDevSerialNumber().equals("A6007pN3")) {
//				ft232handle = fTDevice;
//			}
//		}
